		...
		<div class="wrapper">
			...
			<div id="BoxRight">
				...
				<ul id="breadcrumb">
					...
					<li>/</li>
					<li><a href="#">Garis Besar Cerita</a></li>
				</ul><!-- end breadcrumb -->
				<div id="content">					
					<ul id="download1">
						<li>
							<div class="dnl_left">
								<img class="imgDownload" src="images/material/icon_download.png" alt=""/>
							</div>
							<div class="dnl_right">
								<a href="#" alt="">Kristalisasi Wahyu 1 - Summer Training 1999</a>
							</div>
						</li>
						<li>
							<div class="dnl_left">
							...
							<div class="dnl_right">
								<a href="#" alt="">Satu Kebangunan Baru - Memorial Day 1999</a>
							</div>
						</li>
					</ul>
