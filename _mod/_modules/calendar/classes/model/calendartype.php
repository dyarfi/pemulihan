...
class Model_CalendarType extends Model_Database {
	...
	public function install () {
		...
		if ($insert_data) {
			$sql	= 'INSERT INTO `'.$this->table.'` (`id`,`name`,`description`,`user_id`, `count`, `order`,`status`,`added`,`modified`)'
				    . ' VALUES '
				    . '(\'1\',\'Name-test-calendartype-sample-one\',\'Description Test calendartype Sample One\', 1, 1, 1,\'publish\',NULL,NULL), '
				    . '(\'2\',\'Name-test-calendartype-sample-two\',\'Description Test calendartype Sample Two\', 1, 1, 2,\'publish\',NULL,NULL);';
