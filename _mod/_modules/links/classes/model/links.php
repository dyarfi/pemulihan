...
class Model_Links extends Model_Database {
	...
	public function install () {
		...
		if ($insert_data) {
			$sql	= 'INSERT INTO `'.$this->table.'` (`id`,`type_id`,`name`,`description`,`user_id`,`count`,`order`,`status`,`added`,`modified`)'
				    . ' VALUES '
				    . '(\'11\',\'1\',\'Name-test-links-sample-one\',\'Description Test Links Sample One\',1,1,1,\'publish\',NULL,NULL), '
				    . '(\'12\',\'2\',\'Name-test-links-sample-two\',\'Description Test Links Sample Two\',1,1,2,\'publish\',NULL,NULL);';
