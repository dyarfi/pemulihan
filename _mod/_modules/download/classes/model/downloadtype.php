...
class Model_DownloadType extends Model_Database {
	...
	public function install () {
		...
		if ($insert_data) {
			$sql	= 'INSERT INTO `'.$this->table.'` '
					...
					. 'VALUES '
					. '(1, \'arus-hayat-voice-note\', \'Arus Hayat Voice Note\', \'Dengarkan Kumpulan Voice Note\', 0,1,0,0, \'publish\', '.time().', 0), '
					. '(2, \'garis-besar-cerita\', \'Garis Besar Cerita\', \'Garis Besar Cerita Description\', 0,1,0,0, \'publish\', '.time().', 0), '
					. '(3, \'kidung\', \'Kidung\', \'Kumpulan kidung-kidung Kristiani\', 0,1,0,0, \'publish\', '.time().', 0), '
					. '(4, \'arus-hayat\', \'Arus Hayat\', \' Arus Hayat Buku Seri Pelajaran Hayat\', 0,1,0,0, \'publish\', '.time().', 0)';
	...
	public function delete ($id = '') {
		...
		$result		= $this->db->delete('download', $where_cond);
